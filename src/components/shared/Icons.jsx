export const HomeIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 10.5L12 5l8 5.5v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-9Z" stroke="currentColor" strokeWidth="1.6" />
    <path d="M9 21v-7a3 3 0 0 1 6 0v7" stroke="currentColor" strokeWidth="1.6" />
  </svg>
);
...
export const CalendarIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M6 6h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2Z" stroke="currentColor" strokeWidth="1.6" />
  </svg>
);
...
export const LogoutIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M21 21V3a2 2 0 0 0-2-2h-6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
  </svg>
);

export const StarIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1 3-6Z" stroke="currentColor" strokeWidth="1.6" />
  </svg>
);
...
export const QrIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9 3H3v6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    <path d="M15 3h6v6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    <path d="M9 21H3v-6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    <path d="M21 21h-6v-6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
  </svg>
);
